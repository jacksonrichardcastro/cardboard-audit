    ...
    <div className="container mx-auto flex items-center justify-center px-4 md:px-6 py-24 min-h-[70vh]">
      <Card className="w-full max-w-2xl text-center bg-card/60 backdrop-blur-sm border-white/10 shadow-xl">
        <CardHeader className="pt-12 pb-6">
          <CardTitle className="text-4xl font-bold tracking-tight">Portfolio Tracker</CardTitle>
        ...
        <CardContent>
          <p className="text-muted-foreground max-w-lg mx-auto">
            Track every card in your collection. Real-time market values, set completion progress, portfolio analytics. Built for serious collectors.
          </p>
        </CardContent>
