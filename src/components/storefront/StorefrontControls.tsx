...
export async function StorefrontControls({ layout, sellerId, sellerHandle, isPreview, cards: binderCards, headerIds, theme, themeScope, woodTrimStyle, storefrontId }: { layout: "grid" | "categories", sellerId: string, sellerHandle: string, isPreview: boolean, cards: any[], headerIds: number[], theme: string, themeScope: string, woodTrimStyle: string, storefrontId: string }) {
