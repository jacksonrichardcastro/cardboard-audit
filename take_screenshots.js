...
(async () => {
  ...
  await page.goto('https://card-bound-paioddqcp-jacksonrichardcastros-projects.vercel.app', { waitUntil: 'networkidle2' });
  ...
  await page.goto('https://card-bound-paioddqcp-jacksonrichardcastros-projects.vercel.app/listings/104', { waitUntil: 'networkidle2' });
  await page.screenshot({ path: 'screenshot_listing_seller_card.png', fullPage: false });

  // 3. Storefront (alexthegrader)
  await page.goto('https://card-bound-paioddqcp-jacksonrichardcastros-projects.vercel.app/alexthegrader', { waitUntil: 'networkidle2' });
